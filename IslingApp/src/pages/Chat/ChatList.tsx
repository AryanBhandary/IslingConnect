...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Image, SafeAreaView, ActivityIndicator, ImageStyle } from "react-native";
...
export default function ChatList() {
    ...
    const renderChatItem = ({ item: chat }: { item: any }) => {
        const otherUser = chat.participants.find((p: any) => p._id !== currentUser?.id);
        ...
        return (
            ...
            >
                <Image
                    source={{ uri: chat.item?.imageUrl || "https://via.placeholder.com/60" }}
...
const styles = StyleSheet.create({
    ...
    header: { flexDirection: "row", alignItems: "center", padding: 15, borderBottomWidth: 1, borderBottomColor: "#F5F5F5", backgroundColor: "#FFF" },
    backButton: { marginRight: 15 },
    headerTitle: { fontSize: 16, fontWeight: "bold", color: "#000000" },
    list: { padding: 15 },
    chatCard: { flexDirection: "row", alignItems: "center", marginBottom: 20, backgroundColor: "#FFF" },
    itemImage: { width: 60, height: 60, borderRadius: 12, backgroundColor: "#F9F9F9" } as ImageStyle,
