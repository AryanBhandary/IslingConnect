...
export default function Departments() {
  ...
  return (
    <View style={styles.departList}>
      ...
      >
        <Image source={require("../../../assets/lf.png")} style={styles.icon} />
        <Text style={styles.optionText}>Lost & Found</Text>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.options}
        onPress={() => navigation.navigate("BookIT")}
      >
        <Image source={require("../../../assets/it.png")} style={styles.icon} />
        <Text style={styles.optionText}>IT Support</Text>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.options}
        onPress={() => navigation.navigate("BookPAT")}
      >
        <Image
