...
export default function PAT_AppointmentManagement() {
        ...
        <div className="mx-10 my-5">
                ...
                {(["all", "Pending", "Confirmed", "Cancelled", "Reschedule Requested"] as const).map((status) => (
                    <button
                        ...
                        className={`px-6 py-2 rounded-full text-sm font-semibold transition-all duration-300 ${statusFilter === status
                            ? "bg-[var(--pat)] text-white shadow-lg translate-y-[-2px]"
            ...
            {loading ? (
                <div className="flex items-center justify-center p-20">
                    <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[var(--pat)]"></div>
                </div>
