        ...
        <div className="mx-4 sm:mx-6 lg:mx-10 my-5">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-2">
                    <div className={`px-4 py-1.5 rounded-full text-xs font-bold ${appointments.length > 0 ? 'bg-[var(--it-bg)] text-[var(--it)]' : 'bg-gray-100 text-gray-400'}`}>
            ...
            {loading ? (
                <div className="flex items-center justify-center p-10">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[var(--it)]"></div>
                </div>
                                ...
                                <div className="p-4">
                                    <div className="flex justify-between items-start mb-3">
                                        ...
                                        <div className="flex items-center gap-1.5 shrink-0">
                                            <LuClock size={14} className="text-[var(--it)]" />
                                            <span className="text-xs font-bold text-[var(--it)]">{app.time}</span>
                                        </div>
                                    </div>
